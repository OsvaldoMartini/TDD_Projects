...
namespace DI.Autofac.BusinessObjects
{
    public class Commerce2
    {
        ...
        public Commerce2(IBillingProcessLocator billingProcessorLocator, ICustomer customer, INotifier notifier, ILogger logger)
        {
        ...
        {
            IBillingProcess billingProcessor = _BillingProcessorLocator.GetBillingProcessor();
