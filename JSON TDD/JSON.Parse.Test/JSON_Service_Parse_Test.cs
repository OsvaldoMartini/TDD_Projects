...
namespace JSON.Parse.Test
{
    ...
    [TestFixture]
    public class JSON_Service_Parse_Test
    {
       ...
       string badData = "{\"results\":null,\"status\":\"ERROR\"}";
        ...
        public void ParseJSonSunsetValue_OnGoodData_ReturnExpectedString()
        {
            ...
            //Action
            string result = Calculator.Service.Concrete.Calculator.ParseSunset(goodData);
            //Assert
        ...
        public void ParseJSonSunsetValue_OnBadData_ThrowArgumentException()
        {
            ...
            try
            {
                string result = Calculator.Service.Concrete.Calculator.ParseSunset(badData);
        ...
        public void ToLocalTime_OnValidValue_ReturnExpectedDateTime()
        {
            ...
            //Action
            DateTime result = Calculator.Service.Concrete.Calculator.ToLocalTime(timeString, date);
